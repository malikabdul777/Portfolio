var VanillaTilt = function() {
    class t {
        ...
        onDeviceOrientation(t2) {
            if (null === t2.gamma || null === t2.beta) return;
            ...
            const e = this.settings.gyroscopeMaxAngleX - this.settings.gyroscopeMinAngleX, i = this.settings.gyroscopeMaxAngleY - this.settings.gyroscopeMinAngleY, s = e / this.width, n = i / this.height, l = (t2.gamma - (this.settings.gyroscopeMinAngleX + this.gammazero)) / s, a = (t2.beta - (this.settings.gyroscopeMinAngleY + this.betazero)) / n;
        ...
        onMouseMove(t3) {
            null !== this.updateCall && cancelAnimationFrame(this.updateCall), this.event = t3, this.updateCall = requestAnimationFrame(this.updateBind);
        }
        onMouseLeave() {
        ...
        extendSettings(t4) {
            ...
            for(var s in e)if (s in t4) i[s] = t4[s];
        ...
        static init(e1, i1) {
            e1 instanceof Node && (e1 = [
                ...
                "vanillaTilt" in e || (e.vanillaTilt = new t(e, i1));
            });
        }
    }
...
//# sourceMappingURL=index.5e67475e.js.map
